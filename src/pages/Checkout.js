            ...
            <div className='row'>
                <div className='col-7'>
                    <div className='checkout-left-data'>
                        ...
                        <nav style={{"--bs-breadcrumb-divider": ">"}} aria-label='breadcrumb'>
                            <ol className='breadcrumb'>
                              <li className='breadcrumb-item'>
                                <Link to='/cart' className='text-dark total-price' style={{textDecoration:'none'}}>Cart</Link>
                              </li>
                              &nbsp; /
                        ...
                        <p className='user-details total'>TomDev@gmail.com</p>
                        ...
                        <div className='w-100'>
                            <input type='text' className='form-control' placeholder='CanTho , Nguyen Van Cu....'/>
                        </div>
                        <div className='flex-grow-1'>
                ...
                <div className='col-5'>
                    ...
                    <div className='d-flex gap-10 align-items-center'>
                        <div className='w-75 d-flex align-items-center gap-10'>
                            ...
                            <div>
                                <h5 className='total-price'>GGD</h5>
                                <p className='total-price'>s / sdsadasd</p>
                            </div>
                        </div>
                        <div className='flex-grow-1'>
